...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DjDd8j3E.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BG0_0JaY.js").then((n) => n.r),
    import("./start-DbQHGt4k.js"),
...
var ROUTER_BASEPATH = "Shahzaib-Ali";
var SERVER_FN_BASE = "/Shahzaib-Ali/_serverFn/";
